...
public class CloudBank_ACH extends BaseTest{
	

	@Test
	@Parameters({"amountvalue","Bank_Name1","URL_Home"})
	public void CloudBank__ACH(String amountvalue,String Bank_Name1,String URL_Home) throws InterruptedException 
	{
        ...
        WebElement amount=driver.findElement(By.xpath("//body/app-root[1]/app-content-layout-v35[1]/div[1]/div[2]/div[2]/app-home-v35[1]/div[1]/div[1]/div[1]/div[1]/app-payments-main-v35[1]/div[1]/div[1]/div[1]/div[1]/div[2]/div[1]/app-cloud-ach-v3[1]/div[1]/div[1]/app-amount-input[1]/div[1]/input[1]"));
	    amount.sendKeys(String.valueOf(amountvalue));
	    WebElement BankAccount= driver.findElement(By.xpath("//body/app-root[1]/app-content-layout-v35[1]/div[1]/div[2]/div[2]/app-home-v35[1]/div[1]/div[1]/div[1]/div[1]/app-payments-main-v35[1]/div[1]/div[1]/div[1]/div[1]/div[2]/div[1]/app-cloud-ach-v3[1]/div[1]/div[3]/div[1]/div[1]/app-cloud-account-dropdown-v35[1]/div[1]/ng-select[1]/div[1]/div[1]/div[2]/input[1]"));
		BankAccount.sendKeys(String.valueOf(Bank_Name1));		 
	    Thread.sleep(2000);
	    driver.findElement(By.xpath("//p[contains(text(),'Tyler petrolium')]")).click();
	    
	    WebElement payee=driver.findElement(By.xpath("//body/app-root[1]/app-content-layout-v35[1]/div[1]/div[2]/div[2]/app-home-v35[1]/div[1]/div[1]/div[1]/div[1]/app-payments-main-v35[1]/div[1]/div[1]/div[1]/div[1]/div[2]/div[1]/app-cloud-ach-v3[1]/div[1]/div[3]/div[3]/app-payee-dropdown-v3[1]/div[1]/ng-select[1]/div[1]/div[1]/div[2]/input[1]"));
		   payee.click(); 
		  ...
		  PayeeAdd.Payee_Add();
		    ...
		    try {
		         ...
		         if(flag==1) {
		            ...
		            CloudBank__ACH(amountvalue, Bank_Name1, URL_Home);
		        }}
		  ...
		  if(flag==0)  
		  {
			 ...
			 Memo.sendKeys("Test");
		   WebElement ACH_Now = driver.findElement(By.xpath("//body/app-root[1]/app-content-layout-v35[1]/div[1]/div[2]/div[2]/app-home-v35[1]/div[1]/div[1]/div[1]/div[1]/app-payments-main-v35[1]/div[1]/div[1]/div[1]/div[1]/div[2]/div[1]/app-cloud-ach-v3[1]/div[1]/div[6]/app-common-button-v35[1]/button[1]"));
		    ACH_Now.click();
	   	    Thread.sleep(6000);

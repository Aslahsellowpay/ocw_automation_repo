...
public class Wallet_to_ACH extends BaseTest{
	
	
	@Test
	@Parameters({"amountvalue","Wallet_Name1","Wallet_Name2","Wallet_Name3","URL_Home"})
	public void Wallet__ACH_Processing(String amountvalue,String Wallet_Name1,String Wallet_Name2,String Wallet_Name3,String URL_Home) throws InterruptedException // Wallet - ACH - Processing
	{
       ...
       WebElement Wallet = driver.findElement(By.xpath("//body/app-root[1]/app-content-layout-v35[1]/div[1]/div[2]/div[2]/app-home-v35[1]/div[1]/div[1]/div[1]/div[1]/app-payments-main-v35[1]/div[1]/div[1]/div[1]/div[1]/div[1]/div[2]/div[1]/div[2]/ng-select[1]/ng-dropdown-panel[1]/div[1]/div[2]/div[3]/span[1]/div[1]/span[1]"));
        ...
        WebElement amount=driver.findElement(By.xpath("//body/app-root[1]/app-content-layout-v35[1]/div[1]/div[2]/div[2]/app-home-v35[1]/div[1]/div[1]/div[1]/div[1]/app-payments-main-v35[1]/div[1]/div[1]/div[1]/div[1]/div[2]/div[1]/app-wallet-ach-v3[1]/div[1]/div[1]/app-amount-input[1]/div[1]/input[1]"));
	    amount.sendKeys(String.valueOf(amountvalue));
		
	    

       WebElement WalletAccount= driver.findElement(By.xpath("//body/app-root[1]/app-content-layout-v35[1]/div[1]/div[2]/div[2]/app-home-v35[1]/div[1]/div[1]/div[1]/div[1]/app-payments-main-v35[1]/div[1]/div[1]/div[1]/div[1]/div[2]/div[1]/app-wallet-ach-v3[1]/div[1]/div[2]/div[1]/app-wallet-dropdown-v3[1]/div[1]/ng-select[1]/div[1]/div[1]/div[2]/input[1]"));
	   ...
	   WebElement payee=driver.findElement(By.xpath("//body/app-root[1]/app-content-layout-v35[1]/div[1]/div[2]/div[2]/app-home-v35[1]/div[1]/div[1]/div[1]/div[1]/app-payments-main-v35[1]/div[1]/div[1]/div[1]/div[1]/div[2]/div[1]/app-wallet-ach-v3[1]/div[1]/div[2]/div[3]/app-payee-dropdown-v3[1]/div[1]/ng-select[1]/div[1]/div[1]/div[2]/input[1]"));
	   payee.click();
	   ...
	   PayeeAdd.Payee_Add();
	    ...
	    try {
	         ...
	         if(flag==1) {
	            ...
	            Wallet__ACH_Processing(amountvalue, Wallet_Name1, Wallet_Name2, Wallet_Name3, URL_Home);
	        }}
	...
	@Test
	@Parameters({"amountvalue","Wallet_Name1","Wallet_Name2","Wallet_Name3","URL_Home"})
	public void Wallet__ACH_Save(String amountvalue,String Wallet_Name1,String Wallet_Name2,String Wallet_Name3,String URL_Home) throws InterruptedException // WALLET - ACH - SAVE
	{
		driver.get(String.valueOf(URL_Home));
		  Thread.sleep(8000);
		WebElement Payfrom = driver.findElement(By.xpath("/html/body/app-root/app-content-layout-v35/div/div[2]/div[2]/app-home-v35/div/div/div/div[1]/app-payments-main-v35/div/div[1]/div/div/div[1]/div[2]/div[1]/div[2]/ng-select/div/div/div[3]"));
	   ...
	   PayeeAdd.Payee_Add();
	    ...
	    try {
	         ...
	         if(flag==1) {
	    		...
	    		payeeDelete.Payee_Delete(URL_Home);
	            driver.navigate().back();
	            Wallet__ACH_Save(amountvalue, Wallet_Name1, Wallet_Name2, Wallet_Name3, URL_Home);
	        }}

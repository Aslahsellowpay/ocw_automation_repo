...
public class CreditCard_to_Wire extends BaseTest{
	
	@Test
	@Parameters({"amountvalue","CreditCard_Name1","CreditCard_Name2","CreditCard_Name3","URL_Home"})
	public void CreditCard_Wire_Processing(String amountvalue,String CreditCard_Name1,String CreditCard_Name2,String CreditCard_Name3,String URL_Home) throws AWTException,InterruptedException  // Card - Wire - Processing
	{
		driver.get(String.valueOf(URL_Home));
	       ...
	       try {
	        ...
	        PayAs.click();
        WebElement PayAsWire =driver.findElement(By.xpath("//body/app-root[1]/app-content-layout-v35[1]/div[1]/div[2]/div[2]/app-home-v35[1]/div[1]/div[1]/div[1]/div[1]/app-payments-main-v35[1]/div[1]/div[1]/div[1]/div[1]/div[1]/div[2]/div[3]/div[2]/ng-select[1]/ng-dropdown-panel[1]/div[1]/div[2]/div[2]/span[1]/div[1]/span[1]"));
        PayAsWire.click();
        WebElement amount=driver.findElement(By.xpath("//body/app-root[1]/app-content-layout-v35[1]/div[1]/div[2]/div[2]/app-home-v35[1]/div[1]/div[1]/div[1]/div[1]/app-payments-main-v35[1]/div[1]/div[1]/div[1]/div[1]/div[2]/div[1]/app-card-wire-v3[1]/div[1]/div[1]/app-amount-input[1]/div[1]/input[1]"));
       ...
       WebElement SelectCARD= driver.findElement(By.xpath("//body/app-root[1]/app-content-layout-v35[1]/div[1]/div[2]/div[2]/app-home-v35[1]/div[1]/div[1]/div[1]/div[1]/app-payments-main-v35[1]/div[1]/div[1]/div[1]/div[1]/div[2]/div[1]/app-card-wire-v3[1]/div[1]/div[2]/div[1]/app-cards-dropdown-v3[1]/div[1]/ng-select[1]/div[1]/div[1]/div[2]/input[1]"));
	   ...
	   WebElement payee=driver.findElement(By.xpath("//body/app-root[1]/app-content-layout-v35[1]/div[1]/div[2]/div[2]/app-home-v35[1]/div[1]/div[1]/div[1]/div[1]/app-payments-main-v35[1]/div[1]/div[1]/div[1]/div[1]/div[2]/div[1]/app-card-wire-v3[1]/div[1]/div[2]/div[3]/app-payee-dropdown-v3[1]/div[1]/ng-select[1]/div[1]/div[1]/div[2]/input[1]"));
	   payee.click();
	   ...
	   BankDetailsButton.click();
	    ...
	    try {
	         ...
	         if(flag==1) {
	            ...
	            CreditCard_Wire_Processing(amountvalue, CreditCard_Name1, CreditCard_Name2, CreditCard_Name3, URL_Home);
	        }}
	  ...
	  if(flag==0)  
	  {
	    ...
	    WebElement Edit = driver.findElement(By.xpath("//body/app-root[1]/app-content-layout-v35[1]/div[1]/div[2]/div[2]/app-home-v35[1]/div[1]/div[1]/div[1]/div[1]/app-payments-main-v35[1]/div[1]/div[3]/div[4]/div[1]/button[1]")); //clicking Bank account edit button
		 ...
		 WebElement WireNow = driver.findElement(By.xpath("//span[contains(text(),'Wire Now')]"));
		 WireNow.click();
		    try {
	            Thread.sleep(5000);
	        } catch (InterruptedException e) {
		    ...
		    WebElement Next12=driver.findElement(By.xpath("//span[contains(text(),'Next')]"));
		    Next12.click();
		 ...
		 @Test
			@Parameters({"amountvalue","CreditCard_Name1","CreditCard_Name2","CreditCard_Name3","URL_Home"})
			public void CreditCard_Wire_Save(String amountvalue,String CreditCard_Name1,String CreditCard_Name2,String CreditCard_Name3,String URL_Home)  // CreditCard - Wire -Save
			{
			 driver.get(String.valueOf(URL_Home));
				   try {
			            Thread.sleep(8000);
			   ...
			   BankDetailsButton.click();
			    ...
			    try {
			         ...
			         if(flag==1) {
			    		...
			    		payeeDelete.Payee_Delete(URL_Home);
			            driver.navigate().back();
			            CreditCard_Wire_Save(amountvalue, CreditCard_Name1, CreditCard_Name2, CreditCard_Name3, URL_Home);
			        }}

...
public class CloudBank_Wire_International extends BaseTest {
	
	@Test
	@Parameters({"amountvalue","Bank_Name1","URL_Home"})
	public void CloudBank_Wire__International(String amountvalue,String Bank_Name1,String URL_Home) throws InterruptedException 
	{
        ...
        WebElement PayAs_Wire__International =driver.findElement(By.xpath("//body/app-root[1]/app-content-layout-v35[1]/div[1]/div[2]/div[2]/app-home-v35[1]/div[1]/div[1]/div[1]/div[1]/app-payments-main-v35[1]/div[1]/div[1]/div[1]/div[1]/div[1]/div[2]/div[3]/div[2]/ng-select[1]/ng-dropdown-panel[1]/div[1]/div[2]/div[3]/span[1]/div[1]/span[1]"));
        PayAs_Wire__International.click();
	    ...
	    driver.findElement(By.xpath("//body/app-root[1]/app-content-layout-v35[1]/div[1]/div[2]/div[2]/app-home-v35[1]/div[1]/div[1]/div[1]/div[1]/app-payments-main-v35[1]/div[1]/div[1]/div[1]/div[1]/div[2]/div[1]/app-cloud-wire-v3[1]/div[1]/div[3]/div[3]/app-payee-dropdown-v3[1]/div[1]/ng-select[1]/div[1]/div[1]/div[2]/input[1]")).click();
		  ...
		  PayeeAdd.Payee_Add();
		    ...
		    try {
		         ...
		         if(flag==1) {
		            ...
		            CloudBank_Wire__International(amountvalue, Bank_Name1, URL_Home);
		        }}
		  ...
		  if(flag==0)  
		  {
		   ...
		   Adding_International_BankAccount NewAccount = new Adding_International_BankAccount();
		   NewAccount.Adding__International_BankAccount();
